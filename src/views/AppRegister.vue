...
export default {
    data() {
        return {
            type1: 'password',
            image1: './src/assets/hide.png',
            type2: 'password',
            image2: './src/assets/hide.png',
            name: '',
            surname: '',
            mail: '',
            password: '',
    ...
    methods: {
        toggle1(e) {
            ...
            if(this.type1 == 'password') {
                this.type1 = 'text'
                this.image1 = './src/assets/show.png'
            } else {
                this.type1 = 'password',
                this.image1 = './src/assets/hide.png'
            }
        },
        toggle2(e) {
            e.preventDefault()
            if(this.type2 == 'password') {
                this.type2 = 'text'
                this.image2 = './src/assets/show.png'
            } else {
                this.type2 = 'password',
                this.image2 = './src/assets/hide.png'
            }
        },
        async CreateUser(e) {
            e.preventDefault()
            if (this.name === '' || this.surname === '' || this.password === '' || this.mail === '') {
    ...
    <div class="wrapper">
			<div class="inner">
				<form @submit="CreateUser" >
					...
					<div class="form-holder">
						<input v-model="password" :type="type1" class="form-control toggle" placeholder="Пароль">
                        <button class="toggle btn btn-outline-secondary" @click="toggle1">
                            <img :src="image1"/>
                        </button>
					</div>
                    <div class="form-holder">
						<input v-model="passwordRepeat" :type="type2" class="form-control toggle" placeholder="Подтвердите пароль">
                        <button class="toggle btn btn-outline-secondary" @click="toggle2">
                            <img :src="image2"/>
                        </button>
					</div>
